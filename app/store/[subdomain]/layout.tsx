...
export default async function StoreLayout({
  ...
  // Get store data for the header/footer
  let store;
  try {
    store = await getStoreBySubdomain(params.subdomain);
  } catch (error) {
    console.error('Error loading store in layout:', error);
    // Continue rendering even if store data fails to load
  }
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Your trusted partner in {industry || 'business'}.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300">info@{params.subdomain}.joelmbaka.site</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-5 w-5 mr-2 mt-0.5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="text-gray-300 block">123 Farm Road</span>
                    <span className="text-gray-300 block">Agriville, AG 12345</span>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-gray-400 text-sm mt-2 md:mt-0">
              Powered by <a href="https://joelmbaka.site" className="text-blue-400 hover:text-blue-300">Titan 2.0</a>
            </p>
          </div>
        </div>
      </footer>
