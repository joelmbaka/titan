...
export default async function StoreContactPage({ params }: PageProps) {
  try {
    ...
    console.log('StoreContactPage - Subdomain:', subdomain);

    const store = await getStoreBySubdomain(subdomain);
    console.log('StoreContactPage - Store data:', store);

    if (!store) {
      console.log('StoreContactPage - Store not found');
      return notFound();
    }
    ...
    console.error('StoreContactPage - Error:', error);
    throw error;
  }
} 